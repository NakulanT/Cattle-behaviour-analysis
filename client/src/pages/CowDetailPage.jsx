...
const CowDetailPage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-800 text-gray-100 flex items-center justify-center p-4">
      <div className="container max-w-6xl mx-auto p-4 bg-gray-900 rounded-lg">
        ...
        <div className="bg-gray-700 shadow-md rounded-lg p-4 text-center text-gray-200">
          <h2 className="text-2xl font-semibold mb-4">Cow IDs in this category</h2>
          {cows && cows.length > 0 ? (
